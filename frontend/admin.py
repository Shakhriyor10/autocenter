...
from frontend.models import Banner, Brand, Car, CarBanner, CarColor, CarFeature, ContactRequest, Employee
...
class EmployeeAdmin(TranslationAdmin):
    list_display = ("full_name", "position", "status", "sort_order", "created_at")
    list_filter = ("status",)
