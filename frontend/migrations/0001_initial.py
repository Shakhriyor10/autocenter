...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(blank=True, max_length=80, verbose_name='Название цвета')),
                ('primary_color', models.CharField(max_length=7, verbose_name='Основной цвет (HEX)')),
                ('secondary_color', models.CharField(blank=True, max_length=7, verbose_name='Второй цвет (HEX)')),
                ('image', models.ImageField(upload_to='cars/colors/', verbose_name='Фото этого цвета')),
                ('sort_order', models.PositiveIntegerField(default=0, verbose_name='Порядок')),
                ('car', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='colors', to='frontend.car', verbose_name='Автомобиль')),
            ],
            options={
